...
def g_iter(n):
    ...
    """
    "*** YOUR CODE HERE ***"
    curr1, curr2, curr3, next = 0, 0, 0, 1
    i = 1
    while i <= n:
        if i <= 2:
            curr1, curr2, curr3, next = curr2, curr3, next, i+1
        else:
            curr1 = curr2
            curr2 = curr3
            curr3 = next
            next = curr3+2*curr2+3*curr1
        i += 1
...
def missing_digits(n):
    ...
    if n < 10:
        ...
        reserved, last1, last2 = n//10, n//10%10, n%10
        if last1 == last2:
            return missing_digits(reserved)
        else:
            return last2-last1-1+missing_digits(reserved)
